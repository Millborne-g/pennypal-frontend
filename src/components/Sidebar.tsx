      ...
      <>
        <Drawer
          ...
          <Box sx={{ overflow: 'auto' }}>
            <List
              subheader={<ListSubheader sx={{fontWeight: 550}}>Menu</ListSubheader>}
            >
              {menu.map((item) => (
                <ListItem key={item.name}>
                  <NavLink to={item.path} style={{width: "100%", textDecoration: "none", color: "inherit"}}>
                    <ListItemButton
                    ...
                    >
                      <ListItemIcon  sx={{color: currentUrl ===item.path? theme.palette.primary.light: ''}}>{item.icon}</ListItemIcon>
                      <ListItemText sx={{color: currentUrl ===item.path? theme.palette.primary.light: ''}}>{item.name}</ListItemText>
                    </ListItemButton>
                  </NavLink>
                </ListItem>
              ))
